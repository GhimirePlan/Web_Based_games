...
/** @type {string} */
const CACHE_VERSION = '1740388156|162882891';
/** @type {string} */
const CACHE_PREFIX = '3D Characters Re-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = '3d_characters.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["3d_characters.html","3d_characters.js","3d_characters.offline.html","3d_characters.icon.png","3d_characters.apple-touch-icon.png","3d_characters.worker.js","3d_characters.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["3d_characters.wasm","3d_characters.pck"];
